    ...
    <section id="portfolio">
        <div className="container">
            <div className="flex items-center justify-between flex-wrap">
                <div className="mb-7 sm:mb-0"> {/* Menggunakan mx-auto untuk mengatur teks ke tengah */}
            ...
            <div className="text-center mt-6">
                    {nextItems < portfolios.length && portfolios.length > 3 && (
                        <button onClick={loadMoreHandler} className="text-white bg-primaryColor hover:bg-smallTextColor py-2 px-4 rounded-[8px] font-[500] ease-in duration-200 mx-auto !important">
                            Load More
                        </button>
                    )}
            </div>
